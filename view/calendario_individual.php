...
<body>
    ...
    <div id="container">
      <div id='parteDaEsquerda'>
        ...
        <button type="button" class="btn btn-light bt-curso">Professor</button>
        <button type="button" class="btn btn-light bt-curso">Turno</button>
        <button type="button" style="margin-top: 400px; text-align: center;" class="btn btn-light bt-curso">Gerar </button>
      </div>
